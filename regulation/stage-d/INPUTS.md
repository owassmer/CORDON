...
| Whether the Osservatorio issued a removal measure and which plants or parcels it covered | Regional removal determination and its incorporated annexes | One adopted act plus its source-defined subject rows | Required population: every Osservatorio determination required by an admitted finding or a reached correction relationship, with consequential incorporated, replacing and supplementary material. No 2024/ST1/municipality exclusion is established. The retained DDS58, DDS11/DDS188 and DDS117 with DDS43/DDS188 readings have source-checked target, correction and event connections. DDS117 reuses three native predecessor associations for its corrected image positions. Broader target/report association coverage, finding attachment, complete annex/correction reconciliation and the remaining population readings are pending. Native associations supply report links where their source tables are readable; they do not supply whole-act meaning. Inspected coverage and unexamined dependencies are stated below under removal measures. DDS74/2024 links old code 1673519 to a different host/place from the laboratory row; DDS138/2024 adopts corrected 1674070 at the report location. Administrative correction or withdrawal of the earlier target remains unestablished; laboratory replacement cannot supply it. Reach (`SPEC.md`, admission): act-dated with live effect; an order is in the population until execution or withdrawal closes it, whatever its date, so this row cannot close without row 11. |
...
confirmed earlier prescriptions remain consequential reading dependencies where
their infected-plant work affects these positions.
...
The earlier acts confirmed by DDS188, laboratory and adopted-area dependencies,
underlying ownership correspondence and actual recipient histories remain pending
in their respective consumers. The ordinary path now supports these native, prose and visible-annex structures;
