...
header roles and scoped report statements. The latest table-header page is supplied as context to later blocks; its meaning is not assigned to them automatically. The model is explicitly configured;
