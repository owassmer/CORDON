...
| CRSFA 1038/2022 and DDS 126/2022 | The administrative reading preserves ten targets and the report selection. PR #24's qualified private reading recovers host/sample-code components and scopes the coordinate-axis issue correctly. Composed consumption still leaves ten links unresolved: coordinate axes are unstated and the act/report host relationship needs source qualification. No relationship is inferred from counts or a taxon synonym. PR #24's eligibility repair must reject uncertain specimen identity while preserving valid correspondence when only the code's assigning authority is unknown; review and integration remain pending. |
...
| Bari native legacy archive | Fourteen declarations preserve their dates/statuses and 28 attachment routes. Eleven qualified certificate readings supply completed intervals through the ordinary consumer; seven identified acts produce 14 publication events. Four act-identity connections remain incomplete: DDS 77/2025's certificate lacks the specific adopting office; three others link to principals 135/2025,153/2025 and 114/2026 whose identity pages, not full contents, were inspected. Clock applicability, recipient effect and response remain separate. Three geography-only certificates were outside this pass. |
...
| Actual Commission hearing | The qualified ordinary transcript reading supplies three reported-removal occurrences: the initial 153 and disputed 174/177 monumental account, a separate Minervino example, and broader nearly 2500 cut down. Scopes remain separate and totals are not summed. The linked index's unrevised status survives on each occurrence. No independent listening occurred; held HLS fragments/frames do not verify speech. Exact execution dates, performers and prescribed-target completion remain unestablished. No minutes or substantive documents are published on the reached page; the mentioned written chronology was not recovered from actual links/bounded official search. |
