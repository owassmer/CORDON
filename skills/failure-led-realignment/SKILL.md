---
name: failure-led-realignment
description: Turn a falsified diagnosis, recurring defect, or source-of-truth contradiction into a bounded correction. Use after a material review failure or when authority and consumers drift; not for ordinary cleanup without a demonstrated failure.
---

# Failure-led realignment

Collect the failing artifact, the proposition it claimed to establish, its source authority, and every consumer before choosing a cure.
