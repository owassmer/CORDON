...
# Usage: CORDON_R2_ACCOUNT=<account id> CORDON_R2_BUCKET=<bucket> scripts/replicate_store.sh [source-root]
...
: "${CORDON_R2_ACCOUNT:?set CORDON_R2_ACCOUNT}" "${CORDON_R2_BUCKET:?set CORDON_R2_BUCKET}"
